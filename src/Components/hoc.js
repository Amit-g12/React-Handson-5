...
const products = [
   {pName: 'Apple', price: 70000, color: 'Black'},
   {pName: 'oneplusTv', price: 20000, color: 'Black'},
   {pName: 'oneplusBag', price: 4000, color: 'Grey'},
   {pName: 'adidas', price: 3500, color: 'Grey'},
   {pName: 'shirt', price: 300, color: 'black'}
]

const withFind = (WrappedComponent) => {
    class withFind extends React.Component{
      constructor(){
        super();
        this.state={
          search: '',
